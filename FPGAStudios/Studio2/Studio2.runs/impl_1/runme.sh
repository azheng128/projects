...
HD_PWD='C:/Users/zhenga6/CoCO/Studio2/Studio2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Segment.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Segment.tcl -notrace
