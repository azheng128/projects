...
HD_PWD='C:/Users/zhenga6/CoCO/LogicFunction/LogicFunction.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logicF.vdi -applog -m64 -messageDb vivado.pb -mode batch -source logicF.tcl -notrace
