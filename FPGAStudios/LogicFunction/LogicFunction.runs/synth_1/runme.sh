...
HD_PWD='C:/Users/zhenga6/CoCO/LogicFunction/LogicFunction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logicF.vds -m64 -mode batch -messageDb vivado.pb -notrace -source logicF.tcl
