...
HD_PWD='C:/Users/zhenga6/CoCO/comparator_2bit/comparator_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zheng_Andy_Studio1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Zheng_Andy_Studio1.tcl -notrace
